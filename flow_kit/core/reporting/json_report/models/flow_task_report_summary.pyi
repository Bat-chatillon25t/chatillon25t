...
class FlowTaskReportSummary(BaseModel):
    """Model class for REST-API representation of a flow task report summary."""
    result: FlowTaskState | None
    validation_problems: list[StrictStr]
    flow_source: FlowTaskReportSummaryFlowSource | None
    request_counters: list[FlowRequestCounter] | None
