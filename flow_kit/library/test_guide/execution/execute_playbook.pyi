...
class ExecutePlaybook(TestGuideBlock):
    """test.guide ExecutionApi: Execute a playbook. This will create execution tasks or a project job."""
    PAR__PLAYBOOK_ID: str
    PAR__PLAYBOOK_EXECUTION_REQUEST: str
    PAR__START_DATE: str
    PAR__CRON_EXPRESSION: str
    PAR__CRON_TIME_ZONE: str
    PAR__CHECK_LAST_EXECUTION: str
