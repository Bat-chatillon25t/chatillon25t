...
class CreateCustomAttributeEntry(TestGuideBlock):
    """test.guide Test_InfrastructureApi: Create a new custom attribute entry for the given test resource machine."""
    PAR__TEST_RESOURCE_MACHINE_ID: str
    PAR__CUSTOM_ATTRIBUTE_ID: str
    PAR__CUSTOM_ATTRIBUTE_ENTRY: str
