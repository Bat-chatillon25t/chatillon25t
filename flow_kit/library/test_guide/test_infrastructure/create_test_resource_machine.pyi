...
class CreateTestResourceMachine(TestGuideBlock):
    """test.guide Test_InfrastructureApi: Create a new test resource machine."""
    PAR__TEST_RESOURCE_ID: str
    PAR__TEST_RESOURCE_MACHINE: str
