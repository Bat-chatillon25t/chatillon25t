...
class RetrieveTestResourceMachineByResourceLocationId(TestGuideBlock):
    """test.guide Test_InfrastructureApi: Retrieve the test resource machine for the given ResourceLocationId."""
    PAR__TEST_RESOURCE_LOCATION: str
    PAR__TEST_RESOURCE_NAME: str
    PAR__TEST_RESOURCE_MACHINE_NAME: str
