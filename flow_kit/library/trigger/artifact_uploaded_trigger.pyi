...
class ArtifactUploadedTrigger(FlowBlock):
    """Block that provides trigger payload of an artifact upload event."""
    ...
    def get_result_definition(self) -> ResultDefinition:
        """This block will return the artifact upload event payload."""