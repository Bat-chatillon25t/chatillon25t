...
class AtxReportUploadedTrigger(FlowBlock):
    """Block that provides trigger payload of an atx report upload event."""
    ...
    def get_result_definition(self) -> ResultDefinition:
        """This block will return the atx upload event payload."""