...
class ExecutionTaskStateChangedTrigger(FlowBlock):
    """Block that provides trigger payload of an execution task state changed event."""
    ...
    def get_result_definition(self) -> ResultDefinition:
        """This block will return the ExecutionTaskStateChangedEvent payload."""