...
class ExportReportFilterTrigger(FlowBlock):
    """Block that provides trigger payload of an export report filter event."""
    ...
    def get_result_definition(self) -> ResultDefinition:
        """This block will return the export report filter event payload."""