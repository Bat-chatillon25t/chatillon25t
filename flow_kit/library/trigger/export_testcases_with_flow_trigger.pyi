...
class ExportTestcasesWithFlowTrigger(FlowBlock):
    """Block that provides trigger payload of an export testcases with flow trigger event."""
    ...
    def get_result_definition(self) -> ResultDefinition:
        """This block will return the UploadEvent payload."""