...
class ExternalEventTrigger(FlowBlock):
    """Block that provides the trigger payload of an external event as string."""
    ...
    def get_result_definition(self) -> ResultDefinition:
        """This block will return the generic payload as string."""