...
class ReleaseStateChangedTrigger(FlowBlock):
    """Block that provides trigger payload of a release state changed event."""
    ...
    def get_result_definition(self) -> ResultDefinition:
        """This block will return the release state changed event payload."""