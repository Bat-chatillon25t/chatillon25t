...
class ReviewCreatedTrigger(FlowBlock):
    """Block that provides trigger payload of a review created event."""
    ...
    def get_result_definition(self) -> ResultDefinition:
        """This block will return the review created event payload."""