...
import tg_api_clients.flow.models
from tg_api_clients.flow import rest
from tg_api_clients.flow.api_response import ApiResponse
from tg_api_clients.flow.api_response import T as ApiResponseT
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(tg_api_clients.flow.models, klass)
